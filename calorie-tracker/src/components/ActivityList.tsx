...
export default function ActivityList({activities, dispatch} : ActivityListProps) {
    ...
    return (
        <>
            ...
            {isEmptyActivities ? 
                <p className="text-center">There are no activities yet...</p>
                :
                activities.map(activity => (
                    ...
                    >
                        <div className="space-y-2 relative">
                            <p className={`absolute -top-8 -left-8 px-10 py-2 text-white uppercase font-bold ${activity.category === 7 ? 'bg-orange-500' : 'bg-lime-500'}`}>
